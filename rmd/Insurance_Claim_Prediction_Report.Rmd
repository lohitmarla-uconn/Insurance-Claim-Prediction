...
df_model_results <- data.frame(
  ...
  Test_Acc    = c(0.82, 0.98, 0.98, 0.92, 0.88, 0.89),
  Test_sens = c(0.97, 0.98, 0.98, 0.90, 0.84, 0.90),
  Test_spec = c(0.97, 0.98, 0.92, 0.93, 0.90, 0.89),
  Train_Acc    = c(1,1 ,1 , 0.92, 0.92, 0.94),
  Train_sens = c(1, 1, 1, 0.90, 0.90, 0.93),
  Train_spec = c(1, 1, 1, 0.93, 0.93, 0.94)
)
